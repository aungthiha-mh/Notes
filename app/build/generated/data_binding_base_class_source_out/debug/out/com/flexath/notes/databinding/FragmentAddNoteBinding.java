...
public final class FragmentAddNoteBinding implements ViewBinding {
  ...
  private FragmentAddNoteBinding(@NonNull ConstraintLayout rootView, @NonNull EditText edTitle,
      @NonNull EditText etDescription, @NonNull FloatingActionButton fabSave) {
  ...
  public static FragmentAddNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddNoteBinding((ConstraintLayout) rootView, edTitle, etDescription,
          fabSave);
    }
