...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNoteEntity = new EntityInsertionAdapter<NoteEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `note_table` (`title`,`description`,`id`) VALUES (?,?,nullif(?, 0))";
      }
    ...
    this.__updateAdapterOfNoteEntity = new EntityDeletionOrUpdateAdapter<NoteEntity>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR REPLACE `note_table` SET `title` = ?,`description` = ?,`id` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object insertNote(final NoteEntity note, final Continuation<? super Unit> continuation) {
  ...
  @Override
  public Object deleteNote(final NoteEntity note, final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
  ...
  @Override
  public Object updateNote(final NoteEntity note, final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
  ...
  public LiveData<List<NoteEntity>> getAllNotes() {
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"note_table"}, false, new Callable<List<NoteEntity>>() {
      @Override
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpTitle,_tmpDescription);
            final int _tmpId;
